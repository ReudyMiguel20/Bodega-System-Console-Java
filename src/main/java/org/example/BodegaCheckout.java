...
public class BodegaCheckout {
    ...
    private double totalBoughtItems;
    ...
    public void sellItems() {
        ...
        while (!userWantToExit) {
            ...
            if (itemToSell == null) {
                ...
                this.totalSoldItems += totalPriceOfItem;
                this.totalItemsSold += productQuantity;
                this.totalBoughtItems += itemToSell.getPriceBought() * productQuantity;
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (splitterInfo.length == 1) {
                    this.totalSoldItems = Double.parseDouble(splitterInfo[0]);
                    break;
                }
    ...
    public void printStatistics() {
        System.out.printf("""
                ...
                %.2f total cash sold.
                %.2f total profit.
                """, this.totalItemsSold, this.totalSoldItems, this.totalSoldItems - this.totalBoughtItems);
    }
